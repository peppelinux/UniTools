...
# ln -s /etc/letsencrypt/live/$SERVER_HOST/fullchain.pem /etc/ipsec.d/certs/$SERVER_CERT
# ln -s /etc/letsencrypt/live/$SERVER_HOST/privkey.pem /etc/ipsec.d/private/$SERVER_KEY
# ln -s /etc/letsencrypt/live/$SERVER_HOST/chain.pem /etc/ipsec.d/cacerts/$SERVER_CA_CERT
